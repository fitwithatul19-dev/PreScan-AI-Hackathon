...
export const PublicPricingPage: React.FC<PublicPricingPageProps> = ({ onNavigate }) => {
  ...
  const comparisonFeatures = [
    ...
    },
    {
      ...
      free: 'Up to 15 min',
      creator: 'Up to 45 min',
      pro: 'Up to 90 min',
      team: 'Up to 180 min (3 hrs)',
    },
    {
    ...
    },
    {
      ...
      creator: 'Fast-Track',
      pro: 'High Priority',
      team: 'Dedicated Priority',
    },
    {
      feature: 'Shareable Client / Editor Links',
      free: false,
      creator: false,
      pro: true,
      team: true,
      ...
      <section className="py-16 sm:py-24 border-b border-neutral-200/80 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 p-4 rounded-xl bg-neutral-50 border border-neutral-200/80 text-center text-xs text-neutral-500 max-w-2xl mx-auto flex items-center justify-center gap-2">
            ...
            <span>
              <strong>Phase 02 Notice:</strong> Billing processing will be activated in an upcoming phase. All signups currently provision full access into the workspace.
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs sm:text-sm text-neutral-500">
              Compare scan quotas, duration allowances, and collaborative tools.
            </p>
          </div>
          ...
          <div className="overflow-x-auto rounded-2xl border border-neutral-200 bg-white shadow-2xs">
            <table className="w-full text-left text-xs text-neutral-700">
              <thead className="bg-neutral-100/70 border-b border-neutral-200 text-neutral-900 font-bold">
                <tr>
                  <th className="p-4 sm:w-1/3">Capability</th>
                  <th className="p-4 text-center">Free</th>
                  <th className="p-4 text-center">Creator</th>
                  <th className="p-4 text-center bg-neutral-200/40">Pro</th>
                  ...
                  <tr key={i} className="hover:bg-neutral-50/60 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      {typeof row.creator === 'boolean' ? (
                        row.creator ? <Check className="w-4 h-4 text-emerald-600 mx-auto" /> : <span className="text-neutral-300">—</span>
                      ) : (
                        row.creator
                      )}
                    </td>
                    ...
                    <td className="p-4 text-center font-medium">
                      {typeof row.team === 'boolean' ? (
                        row.team ? <Check className="w-4 h-4 text-emerald-600 mx-auto" /> : <span className="text-neutral-300">—</span>
                      ) : (
                        row.team
                      )}
                    </td>
